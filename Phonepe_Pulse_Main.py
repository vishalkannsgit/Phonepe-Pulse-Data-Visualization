...
icon = Image.open(r"c:\Users\Visha\OneDrive\Desktop\pP\Phonepe_Pulse_Data_Visualization\phonepe.png")
st.set_page_config(page_title= "Phonepe Pulse Data Visualization | By Vishal Kanna B",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# This dashboard app is created by *Vishal Kanna B*!
...
# MENU 1 - HOME
if selected == "Home":
    st.image(r"c:\Users\Visha\OneDrive\Desktop\pP\Phonepe_Pulse_Data_Visualization\phonepe.png")
    ...
    with col2:
        st.image(r"c:\Users\Visha\OneDrive\Desktop\pP\Phonepe_Pulse_Data_Visualization\computer.png")
...
# EXPLORE DATA - TRANSACTIONS
    if Type == "Transactions":
        ...
        with col1:
            ...
            df2 = pd.read_csv(r'c:\Users\Visha\OneDrive\Desktop\pP\Phonepe_Pulse_Data_Visualization\Data\Statenames.csv')
            df1.State = df2
...
if selected == "About":
    ...
    with col1:
        ...
        st.write("##### What is PhonePe Pulse? PhonePe Pulse is a platform developed by PhonePe, a popular digital payments app in India. The main goal of PhonePe Pulse is to provide insights and information about digital transactions across the country. It tracks the trends in digital payments, allowing businesses, analysts, and the public to understand how digital payments are changing in India.")

        st.write("#### Key Features:")
        st.write(" Data Visualization: PhonePe Pulse uses charts and maps to show transaction data, making it easy to see patterns and trends.")
        st.write("####Transaction Insights:")
        st.write(" Users can view data related to different types of transactions, such as how much is being spent, where the transactions are happening, and which payment methods are being used.")
        st.write("User-Friendly Interface: The platform is designed to be easy to use, with a clean layout that helps users find the information they need quickly.")
        st.write("Regional Data: It provides insights based on different states and cities in India, helping users understand regional differences in payment habits.")
        st.write("Why is it Important? PhonePe Pulse plays a crucial role in understanding the growth of digital payments in India. It helps businesses and policymakers make informed decisions by providing valuable data on consumer behavior and market trends.")
        st.write("#### Who Can Benefit?")
        st.write("Businesses: To analyze payment trends and tailor their services.")
        st.write("Researchers: For studying digital payment habits.")
        st.write("General Public: To stay informed about how digital payments are evolving.")
    ...
    with col2:
        ...
        st.write(" ")
        st.write(" ")
        st.image(r"C:\Users\Visha\OneDrive\Desktop\pP\Phonepe_Pulse_Data_Visualization\spotlight_1.png")
